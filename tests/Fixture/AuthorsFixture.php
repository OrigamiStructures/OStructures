...
class AuthorsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'signature' => ['type' => 'text', 'length' => null, 'null' => true, 'default' => null, 'comment' => 'signature markdown as written', 'precision' => null],
    ...
    public $records = [
        [
            ...
            'active' => 1,
            'created' => '2015-08-17 21:12:02',
            'modified' => '2015-08-17 21:12:02',
            'updated' => '2015-08-17 21:12:02'
        ],
    ];
}
